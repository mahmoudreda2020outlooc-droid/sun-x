...
export default function LandingPage() {
    ...
    const scrollTo = (id: string) => {
        ...
        // Wait for menu close animation to finish (approx 300ms)
        setTimeout(() => {
            ...
            <nav className="absolute top-4 left-1/2 -translate-x-1/2 z-[100] w-[95%] max-w-7xl">
                ...
                >
                    ...
                    <div className="flex items-center justify-between px-12 py-3.5">
                        ...
                        {/* Desktop Links */}
                        <div className="hidden md:flex items-center gap-4 lg:gap-8 md:ml-6">
                        ...
                        {/* Desktop: Right side */}
                        <div className="hidden md:flex items-center gap-3 md:ml-4">
                            <LanguageToggle />
                            <NextLink
                                href="/dashboard"
